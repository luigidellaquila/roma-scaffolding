...
<%
	...
	%><button title="<%=JaniculumWrapper.i18NHint(component)%>" class="<%=JaniculumWrapper.cssClass(component,"button", null)%>" style="<%=JaniculumWrapper.inlineStyle(component, null)%>" id="<%=JaniculumWrapper.id(component,null)%>" type="button" name="<%=JaniculumWrapper.actionName(component)%>"
		<%if(JaniculumWrapper.isDisabled(component)){%> disabled="disabled" <%} %>
