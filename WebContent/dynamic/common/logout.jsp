...
<title><%=Roma.aspect(I18NAspect.class).get("Object.logoutOk.label", request.getLocale())%></title>
</head>
<body>
<br />

<p class="default" align="center"><%=Roma.aspect(I18NAspect.class).get("Object.logoutOk.label", request.getLocale())%><br />
<a href="../../app">Login</a>
<br />
<%
